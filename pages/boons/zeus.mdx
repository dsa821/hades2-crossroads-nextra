import GloriousDisaster from "@/components/duos/glorious-disaster.mdx";
import ApocalypticStorm from "@/components/duos/apocalyptic-storm.mdx";
import ThermalDynamics from "@/components/duos/thermal-dynamics.mdx";
import KillerCurrent from "@/components/duos/killer-current.mdx";
import MasterConductor from "@/components/duos/master-conductor.mdx";
import RomanticSpark from "@/components/duos/romantic-spark.mdx";
import KingsRansom from "@/components/duos/kings-ransom.mdx";
