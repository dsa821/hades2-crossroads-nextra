import { TextHighlight } from "@/components/TextHighlight.tsx";
import { Boon } from "@/components/Boon.tsx";
...
<Boon>Your **Attacks** inflict **Blitz**.</Boon>

### Heaven Flourish (Special)

<Boon>Your **Specials** inflict **Blitz**.</Boon>

### Storm Ring (Cast)

<Boon>
  Your **Ω Cast** also causes lightning bolts to repeatedly strike **1** foe at
  a time.
