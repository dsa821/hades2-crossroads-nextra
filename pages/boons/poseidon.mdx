...
### <TextHighlight type="duo">Island Getaway (Aphrodite)</TextHighlight>

<IslandGetaway />

### <TextHighlight type="duo">Natural Selection (Demeter)</TextHighlight>

<NaturalSelection />

### <TextHighlight type="duo">Killer Current (Zeus)</TextHighlight>

<KillerCurrent />

### <TextHighlight type="duo">Seismic Hammer (Hephaestus)</TextHighlight>

<SeismicHammer />

### <TextHighlight type="duo">Golden Rule (Hera)</TextHighlight>

<GoldenRule />

### <TextHighlight type="duo">Beach Ball (Apollo)</TextHighlight>

<BeachBall />

### <TextHighlight type="duo">Scalding Vapor (Hestia)</TextHighlight>
